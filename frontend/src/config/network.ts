export type AppNetwork = 'anvil' | 'sepolia';
...
const NETWORKS: Record<AppNetwork, NetworkConfig> = {
  anvil: {
    key: 'anvil',
    label: 'Anvil',
    chainId: 31337,
...
export const TARGET_NETWORK = NETWORKS[rawNetwork as AppNetwork];
export const TARGET_NETWORK_LABEL = TARGET_NETWORK.label;
export const TARGET_CHAIN_ID = TARGET_NETWORK.chainId;

export function isExpectedChainId(chainId: number | null | undefined): boolean {
