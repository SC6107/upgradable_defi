...
export const MarketsTable = ({ markets, loading, onSupply, onBorrow, }) => {
    ...
    return (_jsx("div", { className: "bg-slate-800 rounded-lg border border-slate-700 overflow-hidden", children: _jsx("div", { className: "overflow-x-auto", children: _jsxs("table", { className: "w-full text-sm", children: [_jsx("thead", { className: "bg-slate-900 border-b border-slate-700", children: _jsxs("tr", { children: [_jsx("th", { className: "text-left px-6 py-4 font-semibold text-gray-300 cursor-pointer hover:text-white", onClick: () => handleSort('symbol'), children: _jsxs("div", { className: "flex items-center gap-2", children: ["Asset", sortBy === 'symbol' && (_jsx("span", { className: "text-pink-500", children: sortDesc ? '↓' : '↑' }))] }) }), _jsx("th", { className: "text-right px-6 py-4 font-semibold text-gray-300 cursor-pointer hover:text-white", onClick: () => handleSort('totalSupply'), children: _jsxs("div", { className: "flex items-center justify-end gap-2", children: ["Total Supply", sortBy === 'totalSupply' && (_jsx("span", { className: "text-pink-500", children: sortDesc ? '↓' : '↑' }))] }) }), _jsx("th", { className: "text-right px-6 py-4 font-semibold text-gray-300", children: "Total Borrow" }), _jsx("th", { className: "text-right px-6 py-4 font-semibold text-gray-300 cursor-pointer hover:text-white", onClick: () => handleSort('supplyAPY'), children: _jsxs("div", { className: "flex items-center justify-end gap-2", children: ["Supply APY", sortBy === 'supplyAPY' && (_jsx("span", { className: "text-pink-500", children: sortDesc ? '↓' : '↑' }))] }) }), _jsx("th", { className: "text-right px-6 py-4 font-semibold text-gray-300 cursor-pointer hover:text-white", onClick: () => handleSort('borrowAPY'), children: _jsxs("div", { className: "flex items-center justify-end gap-2", children: ["Borrow APY", sortBy === 'borrowAPY' && (_jsx("span", { className: "text-pink-500", children: sortDesc ? '↓' : '↑' }))] }) }), _jsx("th", { className: "text-right px-6 py-4 font-semibold text-gray-300", children: "Utilization" }), _jsx("th", { className: "text-center px-6 py-4 font-semibold text-gray-300", children: "Actions" })] }) }), _jsx("tbody", { className: "divide-y divide-slate-700", children: sortedMarkets.map((market) => {
