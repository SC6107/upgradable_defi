...
const EVENT_FILTERS = ['all', 'Deposit', 'Withdraw', 'Borrow', 'Repay'];
function getExplorerBaseUrl() {
    return import.meta.env.VITE_NETWORK === 'sepolia'
        ? 'https://sepolia.etherscan.io/tx/'
        : 'https://etherscan.io/tx/';
}
export function Transactions({ selectedMarket }) {
